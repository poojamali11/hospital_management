    ...
    <div class="page-banner overlay-dark bg-image" style="background-image: url(img/bg_image_1.jpg);">
        <div class="banner-section">
          <div class="container text-center wow fadeInUp">
            ...
            <h1 class="font-weight-normal">Manage Patients</h1>
          </div> <!-- .container -->
        </div> <!-- .banner-section -->
      </div> <!-- .page-banner -->
                ...
                <form action="" name="sentMessage" id="contactForm" novalidate="novalidate" onsubmit="return validate_form();" method="post">
                    <div class="form-row">
                        <div class="col-sm-4 control-group">
                            ...
                            <input type="text" class="form-control" id="patient_name" name="patient_name" value="<?php echo $_POST['patient_name'];?>" placeholder="Patient Name"/>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="col-sm-4 control-group">
                            <label>Phone Number</label>
                            <input type="text" class="form-control" id="patient_phone" name="patient_phone" value="<?php echo $_POST['patient_phone'];?>" placeholder="Patient Phone"/>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div>
                        <button class="btn btn-primary" type="submit" id="sendMessageButton">Search</button>
                    </div>
                </form>
                <br />
                <?php
