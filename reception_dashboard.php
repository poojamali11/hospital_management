...
<head>
    ...
    if(!$_SESSION['ruserid'])
    {
        echo "<script>window.location = 'reception_login.php';</script>";
    }
          ...
          <div class="container text-center wow fadeInUp">
            <nav aria-label="Breadcrumb">
              <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
                ...
                <li class="breadcrumb-item active" aria-current="page">Reception Dashboard</li>
              </ol>
            </nav>
            <h1 class="font-weight-normal">Reception Dashboard</h1>
          </div> <!-- .container -->
        </div> <!-- .banner-section -->
      </div> <!-- .page-banner -->
